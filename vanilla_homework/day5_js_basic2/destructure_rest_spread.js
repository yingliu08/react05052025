...
function destructureArray2() {
  ...
  // Write your code here
  const [function1, function2, function3, function4] = methods;
  // Log the results
  console.log(function1()); // "GET"
  console.log(function2()); // "POST"
  console.log(function3()); // "PUT"
  console.log(function4()); // "DELETE"
}
destructureArray2();
...
function destructureArray3() {
  ...
  // Write your code here
  const [first, second, third, ...p] = arr;
  console.log(first);
  console.log(second);
  console.log(third);
  console.log(p);
